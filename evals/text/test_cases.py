    ...
    Case(
        ...
        evaluators=(
            ...
            LLMJudge(
                model=judge_model,
                rubric=(
                    "The rationale should clearly explain why the text is professional, polite, "
                    "and friendly, and confirm that no moderation flags (PII, unfriendly tone, "
                    "or unprofessional content) were raised."
                ),
                include_input=True,
            ),
        ),
