...
class AudioModerationResult(ModerationResult):
    ...
    is_unfriendly: bool = Field(description="Whether unfriendly tone or content was detected in the audio.")
    is_unprofessional: bool = Field(description="Whether unprofessional tone or content was detected in the audio.")
